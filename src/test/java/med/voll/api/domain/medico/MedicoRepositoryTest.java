...
class MedicoRepositoryTest {
    ...
    private DatosDireccionMedico datosDireccionMedico() {
        return new DatosDireccionMedico(
                " loca",
                "azul",
                "acapulpo",
                "321",
    ...
    private DatosDireccionPaciente datosDireccionPaciente() {
